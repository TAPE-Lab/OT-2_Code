...
def run(protocol: protocol_api.ProtocolContext):
    ...
    DMSO_reservoir = protocol.load_labware('thermoscientific_1_reservoir_300000ul', 3)
    #OR
    #DMSO_reservoir = protocol.load_labware('opentrons_6_tuberack_falcon_50ml_conical', 3)


    #This is the SOURCE
    Te122 = tuberack.well('A6')   #ENTER LOCATION
    ...
    Te122_headroom = 28.5
    Te123_headroom = 28.5               #ENTER DEPTH FROM MINICUS TO TOP OF VIAL 
    Te124_headroom = 28.5
    Te125_headroom = 28.5
    Te126_headroom = 28.5
    Te128_headroom = 28.5
    ...
    for location, volume in DMSO_dict.items():
        ...
        #The DMSO was not transferred on the 25th well onwards
        #maybe need the 50 mL conical flask for the 35-Plex 
        #OR need to use more than 35 mL of DMSO in the reservoir.
        #OR need the pipette to go even deeper into the reservoir when aspirating (not good idea though)
    ...
    #View google sheet https://docs.google.com/spreadsheets/d/1LDdmPOm5x4OusJsionGAwiSJmu85d_i0CbxwSymLn04/edit#gid=0
    #for the calculations behind the volumes below
    ...
    TOBis13,
    TOBis14,
    TOBis15], p20_single, mm_lost_per_ul)
    ...
    TOBis23,
    TOBis24,
    TOBis25], p20_single, mm_lost_per_ul)
    ...
    TOBis29,
    TOBis30,
    TOBis31], p20_single, mm_lost_per_ul)
    ...
    TOBis32,
    TOBis33,
    TOBis34], p20_single, mm_lost_per_ul)
    ...
    TOBis32,
    TOBis33,
    TOBis35], p20_single, mm_lost_per_ul)
