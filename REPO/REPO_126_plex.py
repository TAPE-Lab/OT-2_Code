...
def distribute_dissociation_solution_02(dissociation_solution_reservoir_source, WellPlate_96_destination, pipette, tiprack):
    pipette.distribute(150, dissociation_solution_reservoir_source.bottom(2), WellPlate_96_destination, new_tip='never', disposal_volume=0, blow_out=True, blowout_location='source well')
    pipette.distribute(50, dissociation_solution_reservoir_source.bottom(2), WellPlate_96_destination, new_tip='never', disposal_volume=0, blow_out=True, blowout_location='source well')
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    temp_mod_03 = protocol.load_module('temperature module gen2', 7)
    temp_mod_plate_02 = temp_mod_03.load_labware('helenawith3mmaluminiumplate_96_wellplate_400ul', 7)

    temp_mod_04 = protocol.load_module('temperature module gen2', 9)
    temp_mod_collection_reservoir = temp_mod_04.load_labware('thermoscientific_1_reservoir_300000ul', 9)
    ...
    plate_02 = [temp_mod_plate_02.wells_by_name()['A1'],
    temp_mod_plate_02.wells_by_name()['A2'],
    temp_mod_plate_02.wells_by_name()['A3'],
    temp_mod_plate_02.wells_by_name()['A4']]
    ...
    temp_mod_03.target
    temp_mod_03.status
    temp_mod_04.set_temperature(4)
    temp_mod_04.temperature
    temp_mod_04.target
    temp_mod_04.status
    ...
    distribute_dissociation_solution_02(temp_mod_dissociation_solution.well('A1'), plate_02,  p300_multi_right, tiprack)
    ...
    remove_cells_from_plate_using_wide_bore_tip(plate_02, 50, temp_mod_collection_reservoir.well('A1'), 200, p300_multi_right, wide_bore_tiprack)
    ...
    remove_cells_from_plate_using_narrow_bore_tip(plate_02, 50, temp_mod_collection_reservoir.well('A1'), 300, p300_multi_right, tiprack)
